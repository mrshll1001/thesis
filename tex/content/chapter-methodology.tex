...
The goal of fieldwork in this research was to provide a corpus of data that could be used to understand how those operating in the design space (workers at charitable organisations) reasoned about their work, their finances, and what role digital technologies played in this. Taking an ethnomethodolgical orientation to the fieldwork allows the investigation to focus on pragmatics of how accounting work is done in charities, how members of these settings engage with each other accountably, and thus how organisational Transparency and Accountability are ``done'' \cite{crabtree_doing_2012, garfinkel_studies_1967}

% Explore ethnomethodology's focuses and orientations to epistemology
Ethnomethodology concerns itself with \bollocks{THIS THAT AND THE OTHER}. Its focus on \bollocks{XYZ} gives it attitudes rooted in Phenomenology \cite{sharrock_ethnomethodologists_1986}.
...
% The indifference
One notable feature of Ethnomethodology is the `indifference' to which it applies
